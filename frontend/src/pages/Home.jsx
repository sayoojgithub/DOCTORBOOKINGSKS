  ...
  return <>
    {/*hero section*/}
      ...
      <section>
        ...
        <p className='text-para text-center'>World-class care for everyone.Our health system offers unmatched,
           expert health care.
     ...
     <section>
      ...
      <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
        ...
        <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] ig:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full'>
          Consultation
        </div>
